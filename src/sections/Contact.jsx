...
const Contact = () => {
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/shivamoza26',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/shivamoza26',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6">
              <div className="flex items-center gap-4 p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
                ...
                <div>
                  ...
                  <a href="mailto:shivamoza2006@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                    shivamoza2006@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
                ...
                <div>
                  ...
                  <a href="tel:+918928301587" className="text-green-600 dark:text-green-400 hover:underline">
                    +91 89283 01587
                  </a>
                </div>
              </div>
              ...
              <div className="flex justify-center gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 group"
                    title={link.name}
                  >
